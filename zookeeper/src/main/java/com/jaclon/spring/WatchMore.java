...
public class WatchMore
{
	...
	*/
	private static final Logger logger = Logger.getLogger(com.atguigu.test.WatchMore.class);
	...
	{
		com.atguigu.test.WatchMore watchMore = new com.atguigu.test.WatchMore();
